...
│  --pid 12345 ds status     │
└──────────────┬───────────────────────────────┘
               │  UDS: /run/simm/admin_ds.12345.sock
               ▼
┌──────────────────────────────────────────────┐
...
|-----------|-----------|---------|
| CM | `/run/simm/admin_cm` | `/run/simm/admin_cm.12345.sock` |
| DS | `/run/simm/admin_ds` | `/run/simm/admin_ds.67890.sock` |
...
| Socket path | `/run/simm/simm_trace.<pid>.sock` | `/run/simm/admin_<role>.<pid>.sock` |
